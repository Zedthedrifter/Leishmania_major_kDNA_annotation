...
def main(config_file='config.yaml'):
    ...
    if CSB1_missing.any():
        ...
        if remove_non_CSB1:
            ...
            print('Exiting')
            exit()
    #I commented it out because the sequences are aligned at CSB1 already. Seem to cause some troubles
    ...
    #CSB3_wrong_pos = (minicircles['CSB3_pos'] > 120)
